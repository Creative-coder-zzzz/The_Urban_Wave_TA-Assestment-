  ...
  return (
    <div>
      <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm'>
        ...
        <div>
          <h1 className='text-2xl font-bold tracking-widest'>THE URBAN WAVE</h1>
        ...
        <div>
          ...
          <ul className='flex flex-col gap-1 text-gray-600'>
            <li>+91 892-767-8560</li>
            <li>Contact@theUrbanwave.com</li>
          </ul>
        </div>
      ...
      <div>
        <hr />
        <p className='py-5 text-sm text-center'>Copyright 2025@ theUrbanwave.com - All Right Reserved.</p>
      </div>
