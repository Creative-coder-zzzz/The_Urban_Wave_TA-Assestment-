...
const Navbar = () => {
    ...
    return (
        <div className='flex items-center justify-between py-5 font-medium' >
            ...
            <Link to='/'><h1 className='text-2xl font-bold traking-widest'>THE URBAN WAVE</h1></Link>
        ...
        {isSignedIn ? (
          ...
          <a href="/login" className="text-blue-600 hover:underline">Login</a>
            ...
            <div className={`absolute top-0 right-0 bottom-0 z-10 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`} >
...
//agar clerk nahi chala toh use karuga yeh!
